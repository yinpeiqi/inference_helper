...
python3 -u exp/baseline/run.py --model GCN --use-uva --dataset ogbn-papers100M --batch-size 200000 --num-layers 2
python3 -u exp/baseline/run.py --model GAT --use-uva --dataset ogbn-papers100M --batch-size 200000 --num-layers 2
python3 -u exp/baseline/run.py --model JKNET --use-uva --dataset ogbn-papers100M --batch-size 200000 --num-layers 1
